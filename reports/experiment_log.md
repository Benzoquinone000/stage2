...
- Output: `agnews_dpcnn/outputs/bert5_pseudoDpcnnAll11_textcnn_best_blend`.
...
- pseudo-DPCNN all11 ensemble:
  - predictions: `agnews_dpcnn/outputs/dpcnn_pseudo_all11_ensemble/ensemble_predictions.tsv`
  - test macro F1: `0.929816`
- TextCNN3 ensemble:
  - predictions: `agnews_dpcnn/outputs/textcnn_3probe_ensemble/ensemble_predictions.tsv`
  - test macro F1: `0.923916`

## Useful Baselines

- `agnews_dpcnn/outputs/dpcnn_5fold_regularized/ensemble`: regularized DPCNN five-fold probability ensemble, test macro F1 `0.926390`.
- `agnews_dpcnn/outputs/bert_dpcnn_blend_w033`: BERT five-fold + DPCNN five-fold probability blend, test macro F1 `0.937798`.
- `agnews_dpcnn/outputs/bert5_cleanDpcnn5_pseudo_all11_best_blend`: BERT5 + clean DPCNN5 + pseudo-DPCNN all11, test macro F1 `0.940318`.
...
- Hard-label DPCNN:
  - output: `agnews_dpcnn/outputs/dpcnn_pseudo_db02_rob47_el51_agree2_bal12k_seed120`
  - best valid macro F1: `0.925030`
  - test macro F1: `0.918839`
- Soft-label DPCNN:
  - output: `agnews_dpcnn/outputs/dpcnn_distill_db02_rob47_el51_agree2_bal12k_a04_t2_seed121`
  - best valid macro F1: `0.916295`
  - test macro F1: `0.909787`
  - output: `agnews_dpcnn/outputs/dpcnn_distill_db02_rob47_el51_agree2_bal12k_a02_t2_seed122`
  - best valid macro F1: `0.921874`
  - test macro F1: `0.915879`
- Hard-label TextCNN:
  - output: `agnews_dpcnn/outputs/textcnn_pseudo_db02_rob47_el51_agree2_bal12k_seed320`
  - best valid macro F1: `0.923872`
  - test macro F1: `0.917800`
- Soft-label TextCNN:
  - output: `agnews_dpcnn/outputs/textcnn_distill_db02_rob47_el51_agree2_bal12k_a02_t2_seed321`
...
- Fusion check:
  - sweep file: `agnews_dpcnn/outputs/new_teacher_student_small_weight_sweep.json`
...
- Current final output should remain
  `agnews_dpcnn/outputs/bert5_pseudoDpcnnAll11_textcnn_best_blend`.
...
- Strict pseudo-DPCNN5 baseline:
  - output: `agnews_dpcnn/outputs/dpcnn_pseudo_t098_bal12k_5fold/ensemble`
  - test macro F1: `0.925663`
  - test accuracy: `0.925789`
- Strict pseudo-TextCNN5 baseline:
  - output: `agnews_dpcnn/outputs/textcnn_pseudo_t098_bal12k_5fold/ensemble`
  - test macro F1: `0.924061`
  - test accuracy: `0.924211`
- Strict three-way fold blend:
  - output: `agnews_dpcnn/outputs/bert5_dpcnn5_textcnn5_strictfold_weight_sweep`
...
- Expanded the best DPCNN probe to strict five-fold:
  - output: `agnews_dpcnn/outputs/dpcnn_pseudo_t098_bal12k_5fold_cosine_short_lr6e4/ensemble`
...
- DPCNN5 architecture upgrade:
  - output: `agnews_dpcnn/outputs/dpcnn_pseudo_t098_bal12k_5fold_b5_do065_lr6e4/ensemble`
...
- TextCNN5 architecture upgrade:
  - output: `agnews_dpcnn/outputs/textcnn_pseudo_t098_bal12k_5fold_wide_cosine_short_lr8e4/ensemble`
...
- Three-branch-only fusion:
  - output: `agnews_dpcnn/outputs/bert5_dpcnn5b5_textcnn5wide_only3_weight_sweep`
...
- TextCNN5-base alternative in the same three-branch setup:
  - output: `agnews_dpcnn/outputs/bert5_dpcnn5b5_textcnn5base_only3_weight_sweep`
...
- Coarse sweep:
  - output:
    `agnews_dpcnn/outputs/bert5ultra_dpcnn5b5_textcnn5wide_only3_weight_sweep`
  - weights: BERT5-ultra `0.38`, DPCNN5-b5 `0.48`, TextCNN5-wide `0.14`
  - test macro F1: `0.940870`
  - test accuracy: `0.940921`
- Fine local sweep:
  - output:
    `agnews_dpcnn/outputs/bert5ultra_dpcnn5b5_textcnn5wide_only3_weight_sweep_fine`
...
- Coarse sweep:
  - output:
    `agnews_dpcnn/outputs/bertbase5scratch_dpcnn5b5_textcnn5wide_only3_weight_sweep`
...
- Fine sweep:
  - output:
    `agnews_dpcnn/outputs/bertbase5scratch_dpcnn5b5_textcnn5wide_only3_weight_sweep_fine`
...
- Two-model ablation without TextCNN:
  - output:
    `agnews_dpcnn/outputs/bertbase5scratch_dpcnn5b5_only2_weight_sweep_fine`
...
- OOF probability outputs:
  ...
  - DPCNN5-b5:
    `agnews_dpcnn/outputs/dpcnn_pseudo_t098_bal12k_5fold_b5_do065_lr6e4/oof`
  - TextCNN5-wide:
    `agnews_dpcnn/outputs/textcnn_pseudo_t098_bal12k_5fold_wide_cosine_short_lr8e4/oof`
- OOF single-model valid macro F1:
  - BERT-base scratch5: `0.926140`
  - DPCNN5-b5: `0.922531`
  - TextCNN5-wide: `0.921899`
- OOF-selected two-model blend:
  - output: `agnews_dpcnn/outputs/bertbase5scratch_dpcnn5b5_only2_oof_weight_sweep_fine`
...
- OOF-selected three-model blend:
  - output:
    `agnews_dpcnn/outputs/bertbase5scratch_dpcnn5b5_textcnn5wide_only3_oof_weight_sweep_coarse`
...
- Reorganized the CNN project into a script-plus-package structure:
  - reusable modules: `agnews_dpcnn/src/agnews_dpcnn/{data,models,training,metrics,probabilities}.py`
  - CLI entrypoints remain in `agnews_dpcnn/scripts/`
...
- Updated `reports/agnews_report_package.zip` so the submission archive includes
  the refactored scripts and `agnews_dpcnn/src/agnews_dpcnn` package.
...
- Audited similar structure issues across the project:
  - moved BERT-branch shared helpers from `agnews_classification/task2_*.py` to
    `agnews_classification/src/agnews_classification/`
  - updated BERT scripts and teacher pseudo-label data preparation to import
    shared helpers from the package path
  - normalized final report paths to repository-root-relative paths, e.g.
    `agnews_classification/...` and `agnews_dpcnn/...`
- Verification:
