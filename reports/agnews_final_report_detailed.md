...
| test 概率融合 | `agnews_dpcnn/scripts/sweep_blend_probabilities.py` |
| OOF 预测 | `agnews_classification/scripts/make_bert_oof_predictions.py`、`agnews_dpcnn/scripts/make_dpcnn_oof_predictions.py`、`agnews_dpcnn/scripts/make_textcnn_oof_predictions.py` |
| OOF 权重搜索 | `agnews_dpcnn/scripts/sweep_oof_blend.py` |
...
| 严格二模型结果 | `agnews_dpcnn/outputs/oof_selected_2model/blend_metrics.json` |
| test sweep 三模型上界 | `agnews_dpcnn/outputs/bertbase5scratch_dpcnn5b5_textcnn5wide_only3_weight_sweep_fine/blend_metrics.json` |
