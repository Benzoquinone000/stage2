"""Train a DPCNN text classifier on AG News from scratch."""
...
from agnews_dpcnn.models import DPCNN
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--max-vocab-size", type=int, default=80000)
    parser.add_argument("--min-freq", type=int, default=2)
    parser.add_argument("--max-length", type=int, default=128)
    parser.add_argument("--embedding-dim", type=int, default=300)
    parser.add_argument("--num-filters", type=int, default=250)
...
def main() -> None:
    ...
    train_loader = make_loader(
        train_rows, vocab, args.max_length, args.batch_size, shuffle=True, include_lengths=True
    )
    valid_loader = make_loader(
        valid_rows, vocab, args.max_length, args.batch_size, shuffle=False, include_lengths=True
    )
    test_loader = make_loader(
        test_rows, vocab, args.max_length, args.batch_size, shuffle=False, include_lengths=True
    )
    ...
    print(f"vocab size: {len(vocab):,}; max_length={args.max_length}")
